...
use crate::grpc::node::def::server_types_response::Manifest;

pub mod option_type_as_str {
    use crate::grpc::node::def::server_types_response::manifest::manifest_server_option::ManifestServerOptionType;
